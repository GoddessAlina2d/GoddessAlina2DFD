...
def update_profile():
    ...
    profile_resp = oauth.post(
        ...
        data={"name": new_name, "description": "I'm @GoddessAlina2D's *click* bot now, join me in her herd of bots https://bit.ly/GoddeessAlina2D. Send to Goddess youpay.me/GoddessAlina2D", "location": "*click* send *click* send", "url": "beacons.ai/GoddessAlina2D"}
    )
